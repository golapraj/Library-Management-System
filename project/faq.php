...
<body>
    ...
    <div class="content">
       ...
       <div style="width:850px;float:left;padding-left:10px;padding-top:10px;">
            <div style="font-size:20px; font-weight:bold;">Frequently Asked Questions (FAQs)</div><br />

    

        <div style="font-size:18px; color:green;">How to search by <i>Relevance</i>?</div>

        <div>

            This option allows you to specify the order in which you want the books to be listed. The options available are: popularity of the book, <br />

            the name of the author, title of the book, call number, and dates (publication, acquisition).

        </div>

        

        <div style="font-size:18px; color:green;"><br />How can I browse the physical shelf <i>online</i>?</div>

        <div>

            First you must search for a book of the desired subject area, from the results click on the book closest to your choice. You will be <br />

            taken to another page, when you get there under call number click on <b>browse shelf</b>. Use to                arrows to go left or right.

        </div>

        

        <div style="font-size:18px; color:green;"><br />Can I view the contents of the book online?</div>

        <div>

            You can view electronic contents for a book if it's available. To see if there is any electronic                material such as the book's content or a summary of the

            book search for a book then click on the book's title you will be taken to the book information             page. On that page just above the book's title check for

            electronic materials, if it's there then click the link to view the electronic information.

        </div>

        

        <div style="font-size:18px; color:green;"><br />How to add tags and how can I use them</div>

        <div>

            First search for a book, Above the holdings tab there's a link call "Add". Click on Add 
